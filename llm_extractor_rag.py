"""
RAG-based extractor using Mistral-Small-24B-Instruct (swap MODEL_PATH for Qwen2.5-72B later).
At inference time, retrieves top-K most similar train articles by PubMedBERT
cosine similarity, uses them as few-shot examples in the prompt.
"""
